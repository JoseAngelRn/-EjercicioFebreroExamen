...
#EXAMEN EJERCICIO 2-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function Observaciones($array10, $text){
    foreach ($array10 as $array_10){
    $Vuelo = $array_10["Vuelo"];
    $Observacion = $array_10["Observacion"];
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function Mascota($array9, $Importe, $text, $Maleta, $Codigo, $Divisa, $Mascota){
